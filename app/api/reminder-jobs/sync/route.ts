...
type SyncReminderJobsBody = {
  reminders?: Reminder[];
  deadlines?: Deadline[];
};

function isMissingReminderJobsTableError(error: { message?: string; code?: string } | null) {
...
export async function POST(req: Request) {
  try {
    const body = (await req.json()) as SyncReminderJobsBody;
