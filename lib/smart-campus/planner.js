...
export const PLANNER_CATEGORIES = [
    { id: 'study', label: 'Study', badgeClassName: 'border-cyan-300 bg-cyan-50 text-cyan-800' },
    { id: 'class', label: 'Class', badgeClassName: 'border-violet-300 bg-violet-50 text-violet-800' },
    { id: 'assignment', label: 'Assignment', badgeClassName: 'border-amber-300 bg-amber-50 text-amber-800' },
    { id: 'meeting', label: 'Meeting', badgeClassName: 'border-fuchsia-300 bg-fuchsia-50 text-fuchsia-800' },
    { id: 'wellness', label: 'Wellness', badgeClassName: 'border-emerald-300 bg-emerald-50 text-emerald-800' },
    { id: 'personal', label: 'Personal', badgeClassName: 'border-slate-300 bg-slate-100 text-slate-700' },
];
